    ...
    <section class="hero">
      <div class="hero__content">
        ...
        <div class="hero__actions">
          <a :href="chromeStoreUrl" target="_blank" rel="noopener" class="btn btn--primary btn--large">
        ...
        <div class="steps">
          <div class="step">
            ...
            <div class="step__content">
              <h3 class="step__title">Upload files</h3>
              <p class="step__description">
                Drag and drop PDF files into the browser or select them through the upload dialog
              </p>
            </div>
          </div>
          ...
          <div class="step">
            ...
            <div class="step__content">
              <h3 class="step__title">Arrange order</h3>
              <p class="step__description">
                Use drag & drop to rearrange page order. Add new files, remove unwanted pages
              </p>
            </div>
          </div>
          ...
          <div class="step">
            ...
            <div class="step__content">
              <h3 class="step__title">Download result</h3>
              <p class="step__description">
                Get your merged PDF file with one click
              </p>
            </div>
          </div>
        </div>
...
const buildChromeStoreUrl = (): string => {
  const baseUrl = 'https://chromewebstore.google.com/detail/combine-pdf/onffhmkpneimffpbjfeedikfielemlcb?hl=en'
