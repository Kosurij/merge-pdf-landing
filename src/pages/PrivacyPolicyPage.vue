  ...
  <main class="privacy-policy">
    <div class="container">
      <div class="privacy-policy__content">
        ...
        <p class="privacy-policy__last-updated">Last Updated: 18.08.2025.</p>
        
        <div class="privacy-policy__text">
          <p>This Privacy Policy ("Policy") explains the information collection, use, and sharing practices of Combine PDF ("we," "us," and "our").</p>
          
          <p>Unless otherwise stated, this Policy describes and governs the information collection, use, and sharing practices of Combine PDF with respect to your use of our services ("Services") we provide and/or host on our servers.</p>
          ...
          <p>Combine PDF has designed this policy to be consistent with the following principles:</p>
          <ul>
          ...
          <ul>
            ...
            <li>Comply with the law and protect the safety, rights, property, or security of Combine PDF, the Services, our users, and the general public; and</li>
          ...
          <p>We may disclose your information if required to do so by law or on a good faith belief that such disclosure is permitted by this Privacy Policy or reasonably necessary or appropriate for any of the following reasons: (a) to comply with legal process; (b) to enforce or apply our Terms of Use and this Privacy Policy, or other contracts with you, including investigation of potential violations thereof; (c) enforce our Charter including the Code of Conduct and policies contained and incorporated therein, (d) to respond to your requests for customer service; and/or (e) to protect the rights, property, or personal safety of Combine PDF, our agents and affiliates, our users, and the public. This includes exchanging information with other companies and organizations for fraud protection, and spam/malware prevention, and similar purposes.</p>
          ...
          <p>You may unsubscribe from our marketing emails at any time by clicking on the "unsubscribe" link at the bottom of each newsletter or by emailing kosurij.dm@gmail.com with your request.</p>
          ...
          <p>If you have any questions about this Privacy Policy or our privacy practices, you can contact us at: kosurij.dm@gmail.com.</p>
        </div>
      </div>
    </div>
  </main>
